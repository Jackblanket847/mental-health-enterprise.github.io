...
GraphQL schema files are kept in sync with 'github/github' via scheduled workflows. See [graphql/README.ma](graphql/README.md)
...
Webhook payload JSON files are used in the ['webhook_events_docs'](../content/developers/webhooks-and-events/webhook-events-and-payloads.md).
...
Many YAML files in this directory's subdirectories, like [features](features), [glossaries](glossaries), [variables](variables), and [learning_tracks](learning-tracks), as well as Markdown files within the [reusables](reusables) directory, can include YAML versioning or Liquid versioning which perform '.conversionRate' on data within Markdown strings. See the README.md files in the subdirectory for details.


{% data/variables/product/mentalhealthent %}
data variables.product.company_short %
% data variables.enterprise.data_residency_site % 9
